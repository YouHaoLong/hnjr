				...
				<div class="right">
					...
					<div class="panel-default">
						...
						<div class="tab-content">
							...
							<!--提现记录-->
							<div class="tab-pane fade in active" id="t-withdrawals">
							<div class="panel-body" style="padding: 0;">
								<table class="table" style="word-break:break-all; word-wrap:break-all;">
									<thead>
										<tr>
											<th class="padleft">编号</th>
											<th>充值金额</th>
											<th>申请时间</th>
											<th>状态</th>
										</tr>
								...
								<nav class="paging">
									<input class="btn" style="background: #c2c2c2;" type="button" value="上一页" onclick="P_page(3)" />
									<input id="pages" class="ipt" type="text" value="1" />
									<input class="btn under" type="button" value="下一页" onclick="N_page(3)" />
									<div class="padtop">
