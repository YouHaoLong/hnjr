												...
												<div class="col-md-3">
													<div class="form-group form-group-sm">
														...
														<div class="col-sm-6" style="display: inline-block;">
															<input class="form-control" type="text" id="xxbm" placeholder="自动生成" readonly="">
														</div>
													</div>
												</div>
											...
											<div class="row">
												<div class="col-md-3">
													<div class="form-group form-group-sm">
														...
														<div class="col-sm-6" style="display: inline-block;">
															<input class="form-control" type="text" id="xxuser" placeholder="选择查询" readonly="">
												...
												<div class="col-md-3">
													<div class="form-group form-group-sm">
														...
														<div class="col-sm-6">
															<input class="form-control" type="text" id="xxiphone" placeholder="自动带出" readonly="">
														</div>
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group form-group-sm">
														...
														<div class="col-sm-6">
															<input class="form-control" type="text" id="xxdjr" placeholder="选择查询" readonly="">
												...
												<div class="col-md-3">
													<div class="form-group form-group-sm">
														...
														<div class="col-sm-6">
															<input class="form-control" type="text" id="xxdh" placeholder="自动带出" readonly="">
														</div>
													</div>
												</div>
											</div>
	...
	$.ajax({
		...
		success: function(data) {
			...
			for(var i = 0; i < allList.length; i++) {
				...
				html += '<tr><td>'+allList[i].projectName+'</td><td>'+financingType+'</td><td>'+allList[i].createTime+'</td><td>'+allList[i].name+'</td><td>'+state+'</td><td>'+allList[i].empName+'</td><td><shiro:hasPermission name="/project/viewProject"><a href="/project/toProject?id='+allList[i].id+'" class="btn btn-default btn-sm">查看</a></shiro:hasPermission></td></tr>';
