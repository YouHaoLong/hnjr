...
<html lang="en">
	...
	<body style="background: none; width: 600px; height: 380px;">
		...
		<div class="modal-body">
			<form class="form-horizontal">
				<div class="row">
					<div class="col-md-6" style="width: 50%; float: left;">
						<div class="form-group form-group-sm">
							...
							<label class="col-sm-3 control-label" for="formGroupInputSmall" style="float: left; width: 30%; display: block; font-size: 14px;">编码</label>
							<div class="col-sm-9" style="float: left;">
								<input class="form-control" type="text" id="code" placeholder="请输入编码" value="${organization.code}">
							</div>
						</div>
					</div>
					<div class="col-md-6" style="width: 50%; float: left;">
						<div class="form-group form-group-sm">
							<label class="col-sm-3 control-label" for="formGroupInputSmall" style="float: left; width: 30%; display: block;">部门名称</label>
							<div class="col-sm-9" style="float: left;">
								<input class="form-control" type="text" id="name" placeholder="请输入部门名称" value="${organization.name}">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6" style="width: 50%; float: left;">
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-9" style="float: left;">
								<input class="form-control" type="text" id="seq" value="0" value="${organization.seq}">
							</div>
						</div>
					</div>
					<div class="col-md-6" style="width: 50%; float: left;">
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-9" style="float: left;">
								<input class="form-control" type="text" id="icon" placeholder="请输入菜单图标" value="${organization.icon}">
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-6" style="width: 50%; float: left;">
						<div class="form-group form-group-sm">
							<label class="col-sm-3 control-label" for="formGroupInputSmall" style="float: left;width: 30%; display: block;">地址</label>
							<div class="col-sm-9" style="float: left;">
								<input class="form-control" type="text" id="address" placeholder="请输入地址" value="${organization.address}">
							</div>
						</div>
					</div>
				</div>
