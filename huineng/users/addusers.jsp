					...
					<div class="col-md-6" style="width: 50%; float: left;">
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-9" style="float: left;">
								<input class="form-control" type="text" id="code" placeholder="请输入登录名">
							</div>
						</div>
					</div>
					<div class="col-md-6" style="width: 50%; float: left;">
				...
				<div class="row">
					...
					<div class="col-md-6" style="width: 50%; float: left;">
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-9" style="float: left;">
								<input class="form-control" type="text" id="address" placeholder="请输入年龄">
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-6" style="width: 50%; float: left;">
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-9" style="float: left;">
								<input class="form-control" type="text" id="iphone" placeholder="请输入电话">
							</div>
						</div>
					</div>
					...
					<div class="col-md-6" style="width: 70%; float: left;">
						...
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-9" style="float: left; width: 70%;">
								<input id="citySel" type="text" class="form-control" value="" onclick="showMenu(); return false;" style="float: left; width: 58%; margin-right: 5px;" />
...
//						isParent: true,
	...
	<script>
		function addcon(){
			...
			$.ajax({
			url: '/user/add', // 跳转到 action
			type: 'POST',
			contentType: 'application/x-www-form-urlencoded; charset=UTF-8',
			data:{'loginname':loginname,'name':name,'password':password,'sex':sex,'age':age,'usertype':usertype,'organizationId':organizationId,'roleIds':roleIds,'phone':phone,'status':status},
			dataType: "json", //返回结果格式
			success: function(data) {
				alert(data.msg)
