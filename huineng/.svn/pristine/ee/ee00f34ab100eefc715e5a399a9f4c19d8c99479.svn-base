					...
					<div class="col-md-6" style="width: 50%; float: left;">
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-9" style="float: left;">
								<input class="form-control" type="text" id="name" value="${resource.name}">
							</div>
						</div>
					</div>
					<div class="col-md-6" style="width: 50%; float: left;">
				...
				<div class="row">
					<div class="col-md-6" style="width: 50%; float: left;">
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-9" style="float: left;">
								<input class="form-control" type="text" id="url" value="${resource.url}">
							</div>
						</div>
					</div>
					<div class="col-md-6" style="width: 50%; float: left;">
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-9" style="float: left;">
								<input class="form-control" type="text" id="seq" value="${resource.seq}" >
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6" style="width: 50%; float: left;">
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-9" style="float: left;">
								<input class="form-control" type="text" id="icon" value="${resource.icon}">
							</div>
						</div>
					</div>
					<div class="col-md-6" style="width: 50%; float: left;">
