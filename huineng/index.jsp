...
<body>
<shiro:hasPermission name="/trade/firstTrialOK"></shiro:hasPermission>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-3 col-md-2 sidebar">
			...
			<jsp:include page="/WEB-INF/view/left.jsp" flush="true"></jsp:include>
